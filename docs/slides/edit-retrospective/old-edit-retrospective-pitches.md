...
- [ ] **Robustness to proofreading connectivity**
  ...
  - How much do we need to shrink variance to say anything?
  - Prediction powered inference idea
- [ ] **Robustness to proofreading, morphologies**
...
- [ ] **Completeness level as the object of interest**
  ...
  - There are tons of just disconnected axons, adding those back on would be a huge benefit
