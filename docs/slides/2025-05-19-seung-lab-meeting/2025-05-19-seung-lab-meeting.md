...
section::after {
    content: attr(data-marpit-pagination) '/58';
}
</style>
...
![h:250 center](./images/ca3-good-wo-labels.png)

![h:250 center](./images/ca3-good-w-labels.png)
...
![h:250 center](./images/ca3-bad-wo-labels.png)

![h:250 center](./images/ca3-bad-w-labels.png)
...
![](./images/spine_merge_example.png)
...
![](./images/mesh_texture_example.png)
...
![](./images/profile_approaches/accuracy_comparison.svg)

</div>
<div>

![](./images/profile_approaches/time_comparison.svg)
...
<!-- ![h:550 center](./images/diagram_agglomeration/side_by_side.svg) -->

<div class="columns">
<div>

HKS vector (one timescale)

![h:500 center](./images/diagram_agglomeration/panel1.svg)
...
![h:500 center](./images/diagram_agglomeration/panel2.svg)

</div>
<div>

Reconstructed HKS vector

![h:500 center](./images/diagram_agglomeration/panel3.svg)
...
![](./images/profile_approaches/storage_comparison.svg)
...
* Ran on ~72K neurons
* ~204M synapses classified into &nbsp; <br> { <span style="color: rgb(0, 227, 255);">soma</span> <span style="color: rgb(239, 230, 69);">shaft</span> <span style="color: rgb(233, 53, 161);">spine</span> }
* ~$500 in cloud compute cost
* Version 2 (V1DD): ~65K neurons, 163M synapses, ~$200 in cloud compute cost
...
![h:550 center](./images/boutons/boutons.png)

---

# Other applications? - Axon fragment E/I

<div class="columns">
<div>

* For synapses with E/I labels, made features of
  $[ \text{pre HKS}, \text{post HKS}, \text{synapse size} ]$
* Accuracy on held-out neurons: ~86%
* Local voting helps a lot

</div>
<div>

<!-- ![](./images/min_count_accuracy.svg) -->
