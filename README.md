...
[![Jupyter Book Badge](https://jupyterbook.org/badge.svg)](http://docs.neurodata.io/talks/)
...
- Create a Poetry environment:
  ...
  - For me, the output looks like
     ```
    Creating virtualenv talks in /Users/bpedigo/bilateral-test/talks/.venv
    Using virtualenv: /Users/bpedigo/bilateral-test/talks/.venv
    ```
...
- Instead of running as a Python file, you can also easily convert a Python file to a
  ...
  ```
  sh ./talks/shell/make_notebook er_unmatched_test
  ```
...
- You can then view the locally built HTML by pasting the produced link into your
  browser. For me, the built index is stored at `./talks/docs/_build/html/index.html`


## Questions about the code or paper 
Please get in touch! You are welcome to [make an issue](https://github.com/neurodata/talks/issues/new)
